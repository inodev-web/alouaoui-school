...
export function TeacherDetailsDialog({ teacher, open, onOpenChange }) {
  ...
  const loadRevenueData = async () => {
    ...
    setError(null)
    try {
      const response = await teachersService.getTeacherRevenueDetails(teacher.uuid)
          ...
          <Card>
            ...
            <CardContent>
              ...
              {!loading && !error && !revenueData && (
                <div className="text-center py-8">
                  <p className="text-gray-600 mb-4">لا توجد بيانات إيرادات متاحة</p>
                  <Button onClick={loadRevenueData} variant="outline">
                    إعادة المحاولة
                  </Button>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-lg p-4 border border-purple-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-semibold text-purple-800">حصة الأستاذ</h4>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center py-2 px-3 bg-gray-50 rounded-lg">
                          <span className="text-sm text-gray-600">الطلاب النشطين</span>
                          <span className="font-semibold text-gray-900">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                        <h5 className="font-medium text-amber-800 mb-1">سعر الاشتراك الشهري</h5>
                        <p className="text-xl font-bold text-amber-700">
                          {formatCurrency(revenueData.pricing.subscription_price)}
                        </p>
                      </div>
                      <div className="bg-cyan-50 rounded-lg p-4 border border-cyan-200">
                        <h5 className="font-medium text-cyan-800 mb-1">سعر الحصة الواحدة</h5>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h4 className="font-semibold text-gray-800 mb-2">فترة التقرير</h4>
                    <p className="text-sm text-gray-600">
                      من {formatDate(revenueData.period.from)} إلى {formatDate(revenueData.period.to)}
