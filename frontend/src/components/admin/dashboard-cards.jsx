    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground text-right">
            <span className="text-green-500">نشط</span> في النظام
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground text-right">
            <span className="text-blue-500">مسجل</span> في المنصة
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground text-right">
            <span className="text-green-500">إجمالي</span> الإيرادات
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium text-right">إجمالي الجلسات</CardTitle>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground text-right">
            <span className="text-blue-500">جلسة</span> في الفترة
          </p>
        </CardContent>
      </Card>
    </div>
