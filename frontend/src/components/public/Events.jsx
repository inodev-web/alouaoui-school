...
const Events = () => {
  ...
  const events = [
    {
      id: 1,
      image: 'https://i.pinimg.com/736x/d3/fd/30/d3fd3075a906198427ea0d7112c2f797.jpg',
      author: 'أستاذ الفيزياء',
      title: 'محاضرة الوحدة 1',
      topic: 'الفيزياء',
      description: 'انضم إلينا في محاضرة شيقة عن الفيزياء النووية وتطبيقاتها في الحياة اليومية. سنستكشف أسرار الذرة والقوى النووية',
      thumbnailTitle: 'الفيزياء النووية',
      thumbnailDescription: 'محاضرة تفاعلية'
    },
    {
      id: 2,
      image: 'https://i.pinimg.com/736x/06/ee/ec/06eeec82850b17bb073a5b5fad2b1524.jpg',
      author: 'أستاذ الفيزياء',
      title: 'مراجعة الوحدة 2',
      topic: 'الميكانيكا',
      description: 'ورشة عملية لفهم قوانين نيوتن وتطبيقها في حل المسائل الميكانيكية المعقدة',
    ...
    },
    {
      ...
      topic: 'الكهرباء',
      description: 'استكشف عالم الكهرباء والمغناطيسية وتعلم كيفية عمل الدوائر الكهربائية والمحركات',
  ...
  return (
    ...
    <div className='w-full flex flex-col justify-center items-center py-16'>
        ...
        <div className="text-center col-span-1 md:col-span-2">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-4">الاحداث</h2>
          ...
          {events.map((event, index) => (
            ...
            >
              ...
              <div className="content">
                ...
                <div className="description">{event.thumbnailDescription}</div>
              </div>
            </div>
          ))}
        </div>
