    ...
    <section className="bg-gradient-to-r from-pink-500 to-red-400 flex items-center justify-center py-12 px-4">
      <div className="max-w-6xl mx-auto">
          <div className="text-center col-span-2">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">مميزات المنصة</h2>
              ...
              >
                ...
                <div className="p-8 relative z-10">
                  <div className='flex justify-between items-center'>
                    {/* Icon */}
                    <div className={`w-16 h-16 rounded-2xl bg-white/50 backdrop-blur-sm flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm rounded-full px-3 py-1 pb-3 pl-5 text-2xl font-bold text-gray-800 mb-3 text-right">
                      {feature.title}
                      <div className={`w-2 h-2 rounded-full bg-gradient-to-r mt-1 ${feature.iconColor.replace('text-', 'from-')} to-opacity-60`}></div>
                    </div>
                  </div>
                  {/* Description */}
